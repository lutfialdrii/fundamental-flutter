...
class GetDetailRestaurantResponse {
  ...
  factory GetDetailRestaurantResponse.fromJson(String str) =>
      GetDetailRestaurantResponse.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory GetDetailRestaurantResponse.fromMap(Map<String, dynamic> json) =>
      GetDetailRestaurantResponse(
        error: json["error"],
...
class DetailRestaurant {
  ...
  factory DetailRestaurant.fromMap(Map<String, dynamic> json) => DetailRestaurant(
        id: json["id"],
        name: json["name"],
