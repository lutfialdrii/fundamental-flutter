...
class NotificationHelper {
  ...
  Future<void> scheduleNotification(
    ...
    var dateTime = tz.TZDateTime.now(tz.local).add(const Duration(seconds: 3));
  ...
  Future<void> showBigPictureNotification(
    ...
    var bigPictureStyleInformation = BigPictureStyleInformation(
      ...
      contentTitle: 'overriden <b>big</b> content title',
  ...
  Future<void> showNotificationAttachment(
      FlutterLocalNotificationsPlugin flutterLocalNotificationsPlugin) async {
    var bigPicturePath = await _downloadAndSaveFile(
    ...
    var iosPlatformChannelSpesifics = DarwinNotificationDetails(
